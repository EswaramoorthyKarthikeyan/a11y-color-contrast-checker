...
var ColorContrastChecker = /*#__PURE__*/function () {
  function ColorContrastChecker(containerElement) {
    var criteriaInfo = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {
      fontSize: "23.994px",
      fontWeight: 700,
    ...
    value: function checkContrastForChildren() {
      ...
      try {
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          var contrast = this.calculateContrastRatio(this.getEffectiveBackgroundColor(child), childStyle.color);
          var isValid = false;
          ...
          var childStyleVal = {
            "class": "".concat(child.tagName.toLowerCase(), ".").concat(child.classList.value),
